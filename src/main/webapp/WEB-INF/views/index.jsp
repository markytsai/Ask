                    ...
                    <div class="card mb-4" th:each="question : ${questionList}">
                        <div class="card-block">
                            <h3 class="card-title">
                                ...
                                <%--具体问题和链接--%>
                                <a href="/question/${question.questionId}" class="card-link"
                                   title="${question.questionTitle}">
                                    默认问题名称
                                </a>
                            </h3>
                            <p class="card-text" th:text="${blog.summary}">我收藏夹有一家店，叫士多啤梨R酱小铺。卖欧美“原单”女装的，真假且不论，价格总是比别人家高很多（起码一两百）。微淘里大家评论价格高，而且店主知道别家价格比她低，找贸易去限价。今早我一看微淘，她家40条评论只剩2条了，不利的全删了。我看这卖家不爽，所以我要把她发到知乎来。还有同类店吗？曝光吧
                            </p>
                            <%--尾部信息--%>
                            <div class="card-text">
                                <a href="/u/waylau" th:href="'/u/' + ${blog.username}"
                                   class="card-link" th:text=${blog.username}>waylau</a> 发表于2019年
                                <i class="fa fa-eye" aria-hidden="true">12222</i>
                                <i class="fa fa-heart-o" aria-hidden="true">1212</i>
                                <i class="fa fa-comment-o" aria-hidden="true">12112</i>
                            </div>
                        </div>
